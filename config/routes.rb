ActionController::Routing::Routes.draw do |map|
  ...
  map.resources :odontogramas, :member => {:eliminar => :get}, :collection => {:duplicar => [:get, :post], :ver1 => [:get, :post], :listado => [:get, :post]}
  ...
  map.resources :tareas, :colletion => {:get_tareas => :get}, :member => {:eliminar => :get}
  ...
  map.resources :consultorios, :collection => {:buscar => :get, :resultado => [:get, :post]}
